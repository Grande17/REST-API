...
public class MailCreatorService {
    ...
    public String buildTrelloCardEmail(String message) {
        ...
        context.setVariable("goodbye", "Goodbye, and see you soon!");
        context.setVariable("companyName",adminConfig.getCompanyName());
        context.setVariable("site", adminConfig.getCompanySite());
    ...
    public String buildEmail(String message){
        ...
        context.setVariable("company_details", adminConfig.getAdminName() + " " +adminConfig.getCompanyName()+" "+adminConfig.getCompanySite());
