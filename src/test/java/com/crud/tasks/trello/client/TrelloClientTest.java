...
class TrelloClientTest {
    ...
    void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        when(trelloConfig.getUsername()).thenReturn("mateuszmarkowski17");

        TrelloBoardDto[] trelloBoards = new TrelloBoardDto[1];
        trelloBoards[0] = new TrelloBoardDto("Kodilla", "test_id", new ArrayList<>());

        URI uri = new URI("http://test.com/members/mateuszmarkowski17/boards?key=test&token=test&fields=name,id&lists=all");
